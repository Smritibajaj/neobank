      ...
      <div className="container">
        <div className="text-center grid grid-cols-1 justify-items-center gap-6 lg:grid-cols-12 lg:gap-0">
          <div className="flex flex-col justify-between lg:justify-self-start lg:col-span-3">
            <img
              className="mb-7 w-24 h-20"
              src="images/veenus.png"
              alt="bank logo"
            />
            <div className="flex justify-between items-center">
              <svg
                className="text-neutral-grayish-blue hover:text-green-400 fill-current cursor-pointer"
          ...
          <div className="grid grid-cols-1 gap-2 py-1 lg:grid-rows-3 text-neutral-grayish-blue text-sm lg:text-left lg:justify-self-start lg:col-span-5 lg:gap-x-24 lg:grid-flow-col-dense">
